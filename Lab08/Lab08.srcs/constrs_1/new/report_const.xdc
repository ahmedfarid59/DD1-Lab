...
set_property PACKAGE_PIN W16 [get_ports {in[3]}]					
...
set_property PACKAGE_PIN T3 [get_ports {in[8]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {in[8]}]
set_property PACKAGE_PIN T2 [get_ports {in[9]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {in[9]}]
set_property PACKAGE_PIN R3 [get_ports {in[10]}]					
