...
HD_PWD='C:/Users/ahmed-farid/Desktop/DD1 Lab/DD1-Lab/Lab06/Lab06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CSA8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CSA8.tcl
